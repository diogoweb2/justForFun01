...
var Provider = __webpack_require__(65);

// EXTERNAL MODULE: ./node_modules/react-redux/es/components/connectAdvanced.js
var connectAdvanced = __webpack_require__(26);
...
var wrapMapToProps = __webpack_require__(30);
...
var connect_mergeProps = __webpack_require__(78);

// EXTERNAL MODULE: ./node_modules/react-redux/es/connect/selectorFactory.js
var connect_selectorFactory = __webpack_require__(79);
...
var _es6Promise = __webpack_require__(81);
...
var _currencyReducer = __webpack_require__(85);
...
_es6Promise2.default.polyfill(); /* eslint-disable no-underscore-dangle */


var testClassToRender = document.querySelectorAll(".currencyApp");

var store = void 0;

for (var i = 0; i < testClassToRender.length; i += 1) {
  store = (0, _redux.createStore)(_currencyReducer2.default, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__(), (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
var currencyReducer = function currencyReducer() {
  ...
  switch (action.type) {
    ...
    case "FETCH_API_PENDING":
      return _extends({}, state, { dataLoaded: false });
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return (0, _redux.bindActionCreators)({
    setCurrencyValIn: _currencyActions.setCurrencyValIn,
    setCurrencyValOut: _currencyActions.setCurrencyValOut,
    setCurrencyIn: _currencyActions.setCurrencyIn,
    setCurrencyOut: _currencyActions.setCurrencyOut,
    getCurrencyData: _currencyActions.getCurrencyData,
    setModalDisclaimer: _currencyActions.setModalDisclaimer
  }, dispatch);
};
...
var _InputCurrency = __webpack_require__(88);

var _InputCurrency2 = _interopRequireDefault(_InputCurrency);

var _SelectCurrency = __webpack_require__(89);

var _SelectCurrency2 = _interopRequireDefault(_SelectCurrency);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var _props = this.props,
          currencyValIn = _props.currencyValIn,
          currencyIn = _props.currencyIn,
          currencyValOut = _props.currencyValOut,
          currencyOut = _props.currencyOut,
          setCurrencyValIn = _props.setCurrencyValIn,
          setCurrencyIn = _props.setCurrencyIn,
          setCurrencyValOut = _props.setCurrencyValOut,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "slds-grid slds-gutters slds-wrap" },
          _react2.default.createElement(
            "div",
            { className: "slds-col slds-size_3-of-3" },
            _react2.default.createElement(
              _Label2.default,
              { htmlFor: "currencyValIn" },
              "Type in amount and select currency:"
            )
          ),
          _react2.default.createElement(
            "div",
            { className: "slds-col slds-size_3-of-3 slds-medium-size_2-of-3 " },
            _react2.default.createElement(_InputCurrency2.default, {
              id: "currencyValIn",
          ...
          _react2.default.createElement(
            "div",
            { className: "slds-col slds-size_3-of-3 slds-medium-size_1-of-3 " },
            _react2.default.createElement(_SelectCurrency2.default, { value: currencyIn, onChange: setCurrencyIn })
          ),
          _react2.default.createElement(
            "div",
            { className: "slds-col slds-size_3-of-3  " },
          ...
          _react2.default.createElement(
            "div",
            { className: "slds-col slds-size_3-of-3 slds-medium-size_1-of-3 " },
            _react2.default.createElement(_SelectCurrency2.default, { value: currencyOut, onChange: setCurrencyOut })
          )
        ),
        _react2.default.createElement(
          _Modal2.default,
...
App.propTypes = {
  currencyValIn: _propTypes2.default.string.isRequired,
  currencyIn: _propTypes2.default.string.isRequired,
  currencyValOut: _propTypes2.default.string.isRequired,
  currencyOut: _propTypes2.default.string.isRequired,
  setCurrencyValIn: _propTypes2.default.func.isRequired,
  setCurrencyIn: _propTypes2.default.func.isRequired,
  setCurrencyValOut: _propTypes2.default.func.isRequired,
  setCurrencyOut: _propTypes2.default.func.isRequired,
...
var Modal = function Modal(_ref) {
  var title = _ref.title,
      ...
      handleVisibility = _ref.handleVisibility,
      show = _ref.show;

  if (!show) {
    return _react2.default.createElement(
      _Button2.default,
      { onClick: handleVisibility, type: "link" },
      title
    );
  }
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Button2.default,
            { onClick: handleVisibility, type: "secundary" },
            "Close"
          )
        )
      )
    ),
    _react2.default.createElement("div", { className: "slds-backdrop slds-backdrop_open" })
  );
};
...
var Button = function Button(_ref) {
  ...
  return _react2.default.createElement(
    "button",
    { onClick: onClick, className: typeClass },
    children
  );
};
...
// module
exports.push([module.i, ".currencyWrap {\n  border: 1px solid #999999;\n  background: #ece8e8;\n  padding: 1em; }\n\nh1 {\n  font-size: 2em; }\n", ""]);
